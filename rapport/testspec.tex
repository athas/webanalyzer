...
36 &
Et website indeholdende tre sider, hvoraf en er ``åbenlyst svær'', en
...
\subsubsection{Resultater}
\begin{longtable}[c]{p{20pt}|p{190pt}|p{130pt}|p{130pt}|p{80pt}}
\textbf{Nr.} &
\textbf{Inddata} &
\textbf{Forventet resultat} &
\textbf{Faktisk resultat} &
...
45 &
En side med dansk tekst, hvori dele af sætninger er designeret som
værende kode-ord (med \texttt{kbd}), og disse kode-ord er korrekt
stavede ord på dansk, samt en side med identisk indhold, bortset fra
at kode-ordene er fjernet. &
De to sider har identisk sidesværhedsgrad, kode-ordene er at finde i
output når de er til stede på HTML-siden. &
Kode-ordene bliver talt med når sidesværhedsgraden beregnes, de to
sider har forskellig sidesværhedsgrad. &
Grundet tidsnød blev det valgt ikke at rette dette, det blev opfattet
som en mindre detalje. \\ \hline

46 &
En side med dansk tekst, hvori dele af sætninger er designeret som
værende kode-ord, og disse kode-ord (med \texttt{kdb}) er forkert
stavede ord indenfor sidens angivne sprog, samt en side med identisk
indhold, bortset fra at kode-ordene er fjernet. &
De to sider har identisk sidesværhedsgrad, kode-ordene er at finde i
output når de er til stede på HTML-siden. Kode-ordene skal ikke være
markeret som stavefejl. &
Kode-ordene bliver talt med når sidesværhedsgraden beregnes, de to
sider har forskellig sidesværhedsgrad, men kode-ordene markeres dog
ikke som stavefejl. &
Grundet tidsnød, og det faktum at den vigtigste detalje (at
kode-ordene ikke bliver markeret som stavefejl) fungerer, valgte vi
ikke at rette dette. \\ \hline

47 &
En side med dansk tekst, hvori dele af sætninger er designeret som
værende kode-ord (med \texttt{var}), og disse kode-ord er korrekt
stavede ord på dansk, samt en side med identisk indhold, bortset fra
at kode-ordene er fjernet. &
De to sider har identisk sidesværhedsgrad, kode-ordene er at finde i
output når de er til stede på HTML-siden. &
...
48 &
En side med dansk tekst, hvori dele af sætninger er designeret som
værende kode-ord, og disse kode-ord (med \texttt{var}) er forkert
stavede ord indenfor sidens angivne sprog, samt en side med identisk
indhold, bortset fra at kode-ordene er fjernet. &
De to sider har identisk sidesværhedsgrad, kode-ordene er at finde i
output når de er til stede på HTML-siden. Kode-ordene skal ikke være
...
49 &
En side med dansk tekst, hvori dele af sætninger er designeret som
værende kode-ord (med \texttt{code}), og disse kode-ord er korrekt
stavede ord på dansk, samt en side med identisk indhold, bortset fra
at kode-ordene er fjernet. &
De to sider har identisk sidesværhedsgrad, kode-ordene er at finde i
output når de er til stede på HTML-siden. &
...
50 &
En side med dansk tekst, hvori dele af sætninger er designeret som
værende kode-ord, og disse kode-ord (med \texttt{code}) er forkert
stavede ord indenfor sidens angivne sprog, samt en side med identisk
indhold, bortset fra at kode-ordene er fjernet. &
De to sider har identisk sidesværhedsgrad, kode-ordene er at finde i
output når de er til stede på HTML-siden. Kode-ordene skal ikke være
...
61 &
En side med der indeholder gentagne ord, og hvor mærkning af gentagne ord er slået fra
i analysen. &
Ingen ord markeres som gentagne ord i output. &
Som forventet. &
$\surd$ \\ \hline
...
62 &
En side der indeholder et element med en given \texttt{id}-attribut og
en side der er identisk med den første, men ikke indeholder elementet
med den relevante \texttt{id}-attribut. Programmet er sat til at
filtrere elementet med den relevante \texttt{id}-attribut fra før
analysen. &
Analyseresultatet for de to sider er identisk. &
Som forventet. &
$\surd$ \\ \hline

63 &
En side der indeholder elementer, hver med en af flere givne \texttt{id}-attributter og
en side der er identisk med den første, men ikke indeholder elementerne
med de relevante \texttt{id}-attributter. Programmet er sat til at
filtrere elementer med de relevante \texttt{id}-attributter fra før
analysen. &
Analyseresultatet for de to sider er identisk. &
Som forventet. &
$\surd$ \\ \hline
...
64 &
En side der indeholder et element med en givent tag og
en side der er identisk med den første, men ikke indeholder elementet
med det relevante tag. Programmet er sat til at
filtrere elementet med det relevante tag fra før
analysen. &
Analyseresultatet for de to sider er identisk. &
Som forventet. &
$\surd$ \\ \hline
...
65 &
En side der indeholder elementer, hver med en af flere givne tags og
en side der er identisk med den første men ikke indeholder elementerne
med de relevante tags. Programmet er sat til at
filtrere elementer med de tags fra før
analysen. &
Analyseresultatet for de to sider er identisk. &
Som forventet. &
$\surd$ \\ \hline
...
undersider, som skal indeholde en vis mængde information om det
analyserede website. Afprøvningen af dette krav har et vist overlap
med afprøvningen af krav 1, og de to krav er gensidigt afhængige af at
hverandre fungerer korrekt for at deres tests kan udføre. Afprøvningen
af dette krav vil ikke gå op i hvorvidt analyseresultaterne er
korrekte, kun at de findes i programmets output.
...
Dog har vi testet programmet som en ``standalone'' (SML/NJ runtime
fil, heap image og et shell script til starte programmet) på maskiner
uden SML/NJ installeret. Disse filer er leveret sammen med koden, og
...
\section{Funktionstest--konklusion}
