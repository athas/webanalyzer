...
\begin{verbatim}
  ...
  Disallow: /private 
  Request-rate: 2/10    # Medfører 10sek/2sider = 5sek crawl delay
\end{verbatim}
...
\label{TextAnalyser}
\fixme{hvad skal beholdes? new eller old?}
new:

Analyserer et \texttt{Sentencifyer.document} og finder ord, lange ord (over 6
karakterer) of vokaler pr sætning og antallet af sætninger pr afsnit. og samlet
antal for hele dokumentet. Derefter bliver de foreløbige analyseresultater
givet til de forskellige analyse metoder LIX, FRE og FKGL som returnerer de
individuelle analyse resultater for sætninger, afsnit og hele dokumentet.
Indet den analyserede tekst bliver vist til brugeren bliver analyse resultater
med FRE værier mellem -50 og 200 filtreret fra hvis ikke disse indeholder
...
fandt ud af at de i bedste fald var ligegyldige, og i værste fald
