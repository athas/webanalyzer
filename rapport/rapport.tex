...
relativt nemt at få et program, der kan analysere et helt website, til
...
langt mere interesserede i at analysere hele det website de er
...
undersider på et stort website, forestiller vi os også et brugsmønster
...
website. Ved at angive den ønskede side som URI, og begrænse dybden
...
\subsection{Konfigurationsmuligheder}
Da programmet er skrevet til UNIX platformen har vi valgt ikke at implementere
en desideret config fil, men derimod bruge kommandolinje parametre. Dette
skyldes at men for det meste vil køre programmet med forskellige parametre og i
...
justere fre værdien derefter.\fixme{Skal de stå mere her?}
...
\bibitem{crapbook} Doug Bell: {\em Software Engineering for Students},
  Addison-Wesley (2005)
\end{thebibliography}
