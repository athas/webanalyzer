...
For eksempel vil det følgende HTML--dokument give et parsetræ, som det
illustreret på figur \ref{parse}.
...
(Se... \fixme{stavekontrol}) og det er sat til, sørges der for at
...
index (Se ... \fixme{index}) side og programmet terminerer.
...
Når linksne findes i dokumentet konstrueres en Http.URI (Se URICache \fixme{uri Cache})
