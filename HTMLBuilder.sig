(* HTMLBuilder -- Fancy Functions for building HTML strings
   Taken from Moscow ML Msp, with the CGI capabilities removed. *)

signature HTMLBuilder =
sig
...
(* 
   This module provides support functions for generating HTML.
